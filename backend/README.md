...
- Set `DATABASE_PUBLIC_DOMAIN` and read [the public database hosting guide](../docs/PUBLIC_DATABASES.md) for the Cloudflare/Coolify routing model.
- The panel can also manage this value directly under Settings -> Public Database Routing.
- `DATABASE_PUBLIC_PROTOCOL` defaults to `http` because Cloudflare handles TLS externally.
